...
type MsgRequestLoan struct {
	...
	CollateralType     string `protobuf:"bytes,6,opt,name=collateral_type,json=collateralType,proto3" json:"collateral_type,omitempty"`
	CollateralCoin     string `protobuf:"bytes,7,opt,name=collateral_coin,json=collateralCoin,proto3" json:"collateral_coin,omitempty"`
	CollateralNftClass string `protobuf:"bytes,8,opt,name=collateral_nft_class,json=collateralNftClass,proto3" json:"collateral_nft_class,omitempty"`
	CollateralNftId    string `protobuf:"bytes,9,opt,name=collateral_nft_id,json=collateralNftId,proto3" json:"collateral_nft_id,omitempty"`
}
...
func (m *MsgRequestLoan) GetTerm() uint64 {
	if m != nil {
		return m.Term
	}
	return 0
...
var fileDescriptor_769e3bed04d01bae = []byte{
	...
	,
}
