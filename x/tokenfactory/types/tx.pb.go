...
type MsgCreateDenom struct {
	...
	CreationFee        types.Coin `protobuf:"bytes,9,opt,name=creation_fee,json=creationFee,proto3" json:"creation_fee"`
}
...
func (m *MsgCreateDenom) GetCreationFee() types.Coin {
	if m != nil {
